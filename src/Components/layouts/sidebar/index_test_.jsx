      ...
      */}
      <div className="min-h-full">
        <Transition.Root show={sidebarOpen} as={Fragment}>
          <Dialog as="div" className="relative z-40 lg:hidden" onClose={setSidebarOpen}>
            ...
            <div className="fixed inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-emerald-700 pt-5 pb-4">
                  <Transition.Child
                    as={Fragment}
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
          ...
          <div className="flex flex-grow flex-col overflow-y-auto bg-emerald-700 pt-5 pb-4">
            <div className="flex flex-shrink-0 items-center px-4">
              <img
                className="h-12 w-auto"
                src="../../../favicon.ico"
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            ...
                            className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}
                          >
                   <button onClick={logout}>  <span>ອອກຈາກລະບົບ</span></button>
                          </a>
                        )}
                      </Menu.Item>
                    </Menu.Items>
